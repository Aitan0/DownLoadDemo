...
namespace DMS.UI.SystemManage.EditionManage
{
    public partial class EditionMainForm : CRUDListForm
    {
        ...
        {
            this.SetLogicVisible(new ToolBarCommand[] { this.tbcAdd, this.tbcModify, this.tbcDelete, this.tbcView }, new bool[] { true, true, !(m_CurrentNode as Edition).IsDefault, true });
        }
        #endregion
