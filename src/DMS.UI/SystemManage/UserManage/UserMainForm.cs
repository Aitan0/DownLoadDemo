...
namespace DMS.UI.SystemManage.UserManage
{
    public partial class UserMainForm : CRUDListForm
    {
        ...
        {
            this.SetLogicVisible(new ToolBarCommand[] { this.tbcAdd, this.tbcModify, this.tbcDelete, this.tbcView }, new bool[] { true, true, !(m_CurrentNode as UserInfo).IsDefault, true });
        }
