...
{
	/// <summary>
	/// SelectEmptyRoomManagement 的摘要说明。
	/// </summary>
	public class SelectEmptyRoomManagement : System.Windows.Forms.Form
	{
		...
		public SelectEmptyRoomManagement()
		{
			//
			// Windows 窗体设计器支持所必需的
			//
		...
		private void InitializeComponent()
		{
			...
			this.groupBox2.Location = new System.Drawing.Point(56, 392);
			...
			this.textBox3.Location = new System.Drawing.Point(408, 25);
			...
			// radioButton3
			// 
			this.radioButton3.Location = new System.Drawing.Point(360, 25);
			this.radioButton3.Name = "radioButton3";
			this.radioButton3.Size = new System.Drawing.Size(48, 24);
			this.radioButton3.TabIndex = 12;
			this.radioButton3.Text = "状态";
			...
			// radioButton2
			// 
			this.radioButton2.Location = new System.Drawing.Point(160, 25);
			...
			// btnFind
			// 
			this.btnFind.Location = new System.Drawing.Point(493, 23);
			...
			// btnCancel
			// 
			this.btnCancel.Location = new System.Drawing.Point(501, 24);
			...
			// btnEnd
			// 
			this.btnEnd.Location = new System.Drawing.Point(420, 24);
			...
			// btnNext
			// 
			this.btnNext.Location = new System.Drawing.Point(339, 24);
			...
			// btnBack
			// 
			this.btnBack.Location = new System.Drawing.Point(258, 24);
			...
			// btnFirst
			// 
			this.btnFirst.Location = new System.Drawing.Point(177, 24);
			...
			// btnAll
			// 
			this.btnAll.Location = new System.Drawing.Point(96, 24);
			...
			this.MaximumSize = new System.Drawing.Size(695, 504);
			this.MinimumSize = new System.Drawing.Size(695, 504);
			this.Name = "SelectEmptyRoomManagement";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = " 剩余客房查询";
			this.Load += new System.EventHandler(this.SelectEmptyRoomManagement_Load);
		...
		private void btnFind_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					str = "Select * from 客房信息 where 状态 like '%"+this.textBox3.Text.Trim()+"%'";
					this.sqlSelectCommand1.CommandText = str;
					this.ds.Clear();
					da.Fill(this.ds,"客房信息");
					bmb=this.BindingContext[ds,"客房信息"];
		...
		private void SelectEmptyRoomManagement_Load(object sender, System.EventArgs e)
		{
