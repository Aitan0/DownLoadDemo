...
{
	/// <summary>
	/// ChangeAccountInfoManagement 的摘要说明。
	/// </summary>
	public class ChangeAccountInfoManagement : System.Windows.Forms.Form
	{
		...
		public ChangeAccountInfoManagement()
		{
			//
			// Windows 窗体设计器支持所必需的
			//
		...
		private void InitializeComponent()
		{
			...
			// label10
			// 
			this.label10.Location = new System.Drawing.Point(608, 37);
			...
			this.groupBox2.Location = new System.Drawing.Point(56, 466);
			...
			// btnCancel
			// 
			this.btnCancel.Location = new System.Drawing.Point(524, 21);
			...
			// btnEnd
			// 
			this.btnEnd.Location = new System.Drawing.Point(443, 21);
			this.btnEnd.Name = "btnEnd";
			this.btnEnd.TabIndex = 57;
			this.btnEnd.Text = "最后";
			this.btnEnd.Click += new System.EventHandler(this.btnEnd_Click);
			// 
			// btnNext
			// 
			this.btnNext.Location = new System.Drawing.Point(362, 21);
			...
			// btnBack
			// 
			this.btnBack.Location = new System.Drawing.Point(281, 21);
			...
			// btnFirst
			// 
			this.btnFirst.Location = new System.Drawing.Point(200, 21);
			...
			// btnAll
			// 
			this.btnAll.Location = new System.Drawing.Point(119, 21);
			...
			this.dataGrid1.Location = new System.Drawing.Point(56, 61);
			this.dataGrid1.Name = "dataGrid1";
			this.dataGrid1.ReadOnly = true;
			this.dataGrid1.Size = new System.Drawing.Size(616, 133);
			...
			this.txtRemarks.Location = new System.Drawing.Point(408, 195);
			...
			// label16
			// 
			this.label16.Location = new System.Drawing.Point(320, 197);
			...
			// label15
			// 
			this.label15.Location = new System.Drawing.Point(320, 165);
			...
			this.txtDiscount.Location = new System.Drawing.Point(408, 137);
			...
			// label13
			// 
			this.label13.Location = new System.Drawing.Point(320, 109);
			...
			this.txtMoney.Location = new System.Drawing.Point(408, 79);
			...
			this.txtContents.Location = new System.Drawing.Point(408, 50);
			...
			this.txtIDCard.Location = new System.Drawing.Point(408, 21);
			...
			this.txtName.Location = new System.Drawing.Point(96, 196);
			...
			this.txtPrice.Location = new System.Drawing.Point(96, 167);
			...
			this.txtPosition.Location = new System.Drawing.Point(96, 138);
			...
			this.txtType.Location = new System.Drawing.Point(96, 109);
			...
			this.txtRoomID.Location = new System.Drawing.Point(96, 80);
			...
			this.txtInID.Location = new System.Drawing.Point(96, 51);
			...
			this.txtBillID.Location = new System.Drawing.Point(96, 22);
			...
			// checkBox1
			// 
			this.checkBox1.Location = new System.Drawing.Point(56, 208);
			...
			// btnDelete
			// 
			this.btnDelete.Location = new System.Drawing.Point(568, 208);
			...
			this.MaximumSize = new System.Drawing.Size(736, 600);
			this.MinimumSize = new System.Drawing.Size(736, 600);
			this.Name = "ChangeAccountInfoManagement";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "结算信息修改";
			this.Load += new System.EventHandler(this.ChangeAccountInfoManagement_Load);
		...
		private void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				bmb=this.BindingContext[ds,"帐单明细"];
				this.label9.Text = "当前记录："+(this.dataGrid1.CurrentRowIndex+1);
				this.label10.Text = "记录数："+this.bmb.Count;
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{
					ds.帐单明细.Rows[bmb.Position].Delete();
					da.Update(ds,"帐单明细");
					this.ds.Clear();
					da.Fill(this.ds,"帐单明细");
					bmb=this.BindingContext[ds,"帐单明细"];
		...
		private void ChangeAccountInfoManagement_Load(object sender, System.EventArgs e)
		{
