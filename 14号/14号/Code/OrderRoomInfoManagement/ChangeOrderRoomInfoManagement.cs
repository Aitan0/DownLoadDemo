...
{
	/// <summary>
	/// ChangeOrderRoomInfoManagement 的摘要说明。
	/// </summary>
	public class ChangeOrderRoomInfoManagement : System.Windows.Forms.Form
	{
		...
		public ChangeOrderRoomInfoManagement()
		{
			//
			// Windows 窗体设计器支持所必需的
			//
		...
		private void InitializeComponent()
		{
			...
			// label24
			// 
			this.label24.Location = new System.Drawing.Point(663, 24);
			...
			// label23
			// 
			this.label23.Location = new System.Drawing.Point(55, 24);
			...
			this.dataGrid1.Location = new System.Drawing.Point(53, 48);
			...
			// dtEndTime
			// 
			this.dtEndTime.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds, "预订单.离店时间"));
			this.dtEndTime.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			this.dtEndTime.Location = new System.Drawing.Point(104, 262);
			...
			// dtArrTime
			// 
			this.dtArrTime.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.ds, "预订单.抵店时间"));
			this.dtArrTime.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			this.dtArrTime.Location = new System.Drawing.Point(104, 223);
			...
			this.txtClient.Location = new System.Drawing.Point(336, 261);
			...
			// btnCancel
			// 
			this.btnCancel.Location = new System.Drawing.Point(572, 16);
			...
			// btnEnd
			// 
			this.btnEnd.Location = new System.Drawing.Point(491, 16);
			...
			// btnNext
			// 
			this.btnNext.Location = new System.Drawing.Point(410, 16);
			...
			// btnBack
			// 
			this.btnBack.Location = new System.Drawing.Point(329, 16);
			...
			// btnFirst
			// 
			this.btnFirst.Location = new System.Drawing.Point(248, 16);
			...
			// btnAll
			// 
			this.btnAll.Location = new System.Drawing.Point(167, 16);
			...
			// checkBox2
			// 
			this.checkBox2.Location = new System.Drawing.Point(52, 192);
			...
			// btnDelete
			// 
			this.btnDelete.Location = new System.Drawing.Point(664, 192);
			...
			this.Name = "ChangeOrderRoomInfoManagement";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "订房信息修改";
			this.Load += new System.EventHandler(this.ChangeOrderRoomInfoManagement_Load);
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{
					ds.预订单.Rows[bmb.Position].Delete();
					da.Update(ds,"预订单");
					this.ds.Clear();
					da.Fill(this.ds,"预订单");
					bmb=this.BindingContext[ds,"预订单"];
		...
		private void ChangeOrderRoomInfoManagement_Load(object sender, System.EventArgs e)
		{
